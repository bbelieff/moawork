-- =====================================================================
-- 059_tab_views.sql — V6 뷰 시스템 (F-2, BBE-117)
-- 성격 : additive. 001~058 무수정.
-- 번호 재확정 2026-08-12(NC-04 인수) — origin/main 에 035_ledger.sql 이 이미 있어
-- 충돌. §9.1 대로 머지 직전 최신+1(058→059)로 다시 매겼다. 원안 번호는 035였다.
--
