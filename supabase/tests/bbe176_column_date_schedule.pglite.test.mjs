...
async function database(){
  ...
  await db.exec(`
    ...
    create table org_members(org_id uuid,user_id uuid,role member_role,status text,primary key(org_id,user_id));
    ...
    create table board_columns(id uuid primary key default gen_random_uuid(),org_id uuid references orgs(id),board_id uuid references boards(id),key text,label text,type field_type,archived_at timestamptz,unique(board_id,key));
    create table items(id uuid primary key,org_id uuid references orgs(id),board_id uuid references boards(id));
    ...
    insert into org_members values('${id(1)}','${id(10)}','owner','active'),('${id(1)}','${id(11)}','admin','active'),('${id(1)}','${id(12)}','member','active'),('${id(2)}','${id(13)}','owner','active');
