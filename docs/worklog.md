...
- 리스: 변경 없음. 이어받을 것: 2단 검수(**NG-01** — 마이그레이션·권한) · deepLink 후속 카드.
  ※ 2026-08-12 세션명 혼선 기록 — 한때 «NC 05 로 확인됐다» 며 이 항목·서명·검수 배차(NG-01→DG-01)를
    고쳤으나, belie 가 **원격 세션과 착각한 오정정**이었다고 재정정해 **DC 05 · 2단 NG-01 로 되돌렸다.**
    실제 산출물·SHA·판정은 처음부터 바뀐 적이 없다.
