...
## [모아워크 NC 05] 2026-08-12 — BBE-16 재기동: 재번호 060 · 1단 검수 FAIL 3건 중 2건 수정
...
- 리스: 변경 없음. 이어받을 것: 2단 검수(**DG-01** — 마이그레이션·권한) · deepLink 후속 카드.
  ※ 2026-08-12 정정 — 세션명이 DC 05 가 아니라 **NC 05** 로 확인됐다(온보딩 프롬프트 오기).
    §5 상 NC 의 평시 1단 짝은 NG-01, **2단은 반대편 기계인 DG-01** 이다. 앞서 NG-01 로 적은 것은 틀렸다.
