...
|---|---|---|---|---|---|---|---|
| T03 | `a7bdc9d` PR-0 *(브랜치 한정, main 미포함)* | ✅ 초록 | ✅ 통과(10/10) | ✅ 앱레이어 통과 | ⛔ 미검증(Supabase 미연결) | **조건부 통과 — main 머지 시 재검증** | 2026-07-21 |
| T02 | `cd2193d` | ✅ 초록 | — 미실시 | — | ⛔ 미검증 | 대기 | — |
| T04 | `011f6c6` (홈 대시보드) | ✅ 초록 | ✅ 홈 렌더 확인 | ✅ `?as=` 반영 확인 | ⛔ 미검증 | 부분 | 2026-07-21 |
