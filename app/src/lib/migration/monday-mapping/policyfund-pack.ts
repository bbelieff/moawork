 ...
 * 앱이 쓰는 동일 데이터다. 둘이 어긋나면 `policyfund-pack.test.ts` 가 실패한다.
 *
...
import { POLICYFUND_CONTACT_BOARD } from "./policyfund-contact";
import { POLICYFUND_NEWCUST_BOARD } from "./policyfund-newcust";
import { POLICYFUND_WORK_BOARD } from "./policyfund-work";
 ...
 */
export const POLICYFUND_OPTION_SETS: Record<string, FieldOption[]> = {
 ...
 */
export function allSectionPresets(pack: StructurePack = POLICYFUND_STRUCTURE_PACK): SectionPreset[] {
