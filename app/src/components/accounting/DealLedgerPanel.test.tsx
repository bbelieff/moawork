...
const entries = [
  { id: "deposit-1", dealId: "deal-1", kind: "contract_deposit" as const, amount: 100_000, receivedAmount: 100_000, occurredOn: "2026-08-01", paidOn: "2026-08-01", attributionMonth: "2026-08-01" },
